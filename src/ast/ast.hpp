...
enum ExprK {ID_EXPR, OP_EXPR, UOP_EXPR, CONST_EXPR, STRINGLIT_EXPR, LIST_EXPR, LISTLEN_EXPR, SORT_EXPR, MAP_EXPR, CAR_EXPR, CDR_EXPR, FUNC_EXPR, LAMBDA_EXPR, TYPEOF_EXPR};
