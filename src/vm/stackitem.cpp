...
bool StackItem::lessThan(StackItem& si) {
    switch (si.type) {
        case INTEGER: {
            switch (type) {
...
bool StackItem::equals(StackItem& rhs) {
    if (type != rhs.type)
        return false;
    switch (type) {
...
StackItem& StackItem::sub(StackItem& rhs) {
    if (rhs.type == STRING) {
        return *this;
    } else {
        double v = rhs.type == INTEGER ? rhs.intval:rhs.numval;
...
StackItem& StackItem::mul(StackItem& rhs) {
    if (rhs.type == STRING) {
        return *this;
...
StackItem& StackItem::div(StackItem& rhs) {
    if (rhs.type == STRING) {
        return *this;
    } else {
        double v = rhs.type == INTEGER ? rhs.intval:rhs.numval;
...
StackItem& StackItem::mod(StackItem& rhs) {
    if (rhs.type == STRING) {
        return *this;
    } else {
