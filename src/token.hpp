...
enum Symbol {
    ...
    TK_LENGTH, TK_EMPTY, TK_SORT, TK_FIRST, TK_REST, TK_MAP, TK_FILTER, TK_REDUCE,
...
inline string symbolAsString[] = {
    ...
    "TK_RANGE", "TK_ELIPSE", 
    "TK_OF", 
    "TK_APPEND", "TK_PUSH", "TK_POP", "TK_SHIFT", "TK_UNSHIFT", "TK_LENGTH", "TK_EMPTY", "TK_SORT", "TK_FIRST", "TK_REST", "TK_MAP", "TK_FILTER", "TK_REDUCE",
    "TK_OPEN_COMMENT", "TK_CLOSE_COMMENT", 
    "TK_PIPE", "TK_FOPEN", "TK_EVAL", 
    "TK_TYPEOF", "TK_EOF", "TK_ERROR"
};
