...
enum Symbol {
    ...
    TK_BREAK, TK_CONTINUE, TK_PERIOD, TK_COMA, TK_SEMI, TK_COLON, TK_AMPER, TK_QM, TK_REF, TK_LAMBDA, TK_RANGE,
...
inline string symbolStr[] = {
    ...
    "TK_REDUCE", "TK_REVERSE", "TK_SORT", "TK_PIPE", "TK_MATCHRE", "TK_REMATCH", "TK_TYPEOF", "TK_FOPEN", "TK_TILDA",
    "TK_ERR", "TK_EOI"
};
