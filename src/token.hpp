...
enum Symbol {
    ...
    TK_LET, TK_DEF, TK_RETURN, TK_WHILE, TK_FOR, TK_VAR, TK_REF, TK_INOUT,
    TK_IF, TK_ELSE, TK_PRINT, TK_MATCH, TK_RANGE, TK_ELIPSE, TK_OF,
    TK_APPEND, TK_PUSH, TK_POP, TK_SHIFT, TK_UNSHIFT, TK_LENGTH, TK_EMPTY, TK_SORT, TK_FIRST, TK_REST, TK_MAP, TK_FILTER,
    TK_OPEN_COMMENT, TK_CLOSE_COMMENT, TK_NIL, TK_PIPE, TK_FOPEN, TK_FCLOSE, TK_EVAL, TK_TYPEOF,
    TK_EOF, TK_ERROR
};
